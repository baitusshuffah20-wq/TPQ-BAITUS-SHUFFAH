-- =====================================================
-- BEHAVIOR TRACKING SYSTEM FOR TPQ BAITUS SHUFFAH - CLEAN VERSION
-- =====================================================

-- Drop existing tables if they exist
DROP TABLE IF EXISTS behavior_alerts;
DROP TABLE IF EXISTS character_goals;
DROP TABLE IF EXISTS behavior_records;
DROP TABLE IF EXISTS behavior_criteria;

-- Drop existing views
DROP VIEW IF EXISTS behavior_summary;

-- Drop existing triggers
DROP TRIGGER IF EXISTS behavior_records_updated_at;
DROP TRIGGER IF EXISTS behavior_alert_trigger;
