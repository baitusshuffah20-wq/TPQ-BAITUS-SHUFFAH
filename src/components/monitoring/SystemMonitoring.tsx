  ...
  const runComprehensiveTest = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setTestResults(data);
        toast.success(
          `Test selesai: ${data.summary.passed}/${data.summary.total} passed`,
          { id: "testing" },
        );
      } else {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={runComprehensiveTest} disabled={testing} size="sm">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {healthData.services.healthy}/{healthData.services.total}{" "}
                      healthy
                    </span>
                  </div>
                  <div className="flex justify-between">
