...
export default function HomeProgressTracker({
  ...
  const mockHomeGoals: HomeGoal[] = [
    {
      ...
      parentNotes:
        "Ahmad sudah sangat baik, hanya kadang terlambat shalat Ashar",
  ...
  const completedActivities = todayActivities.filter(
    (a) => a.isCompleted,
  ).length;
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">
            Progress di Rumah - {santriName}
          </h2>
          <p className="text-gray-600">
            Pantau dan catat aktivitas positif anak di rumah
          </p>
        </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {homeGoals.filter((g) => g.status === "ACTIVE").length}
                </p>
              </div>
            </div>
          </CardContent>
            ...
            {todayActivities.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">
                  Mulai catat aktivitas positif anak di rumah
                </p>
                <Button onClick={() => setShowActivityForm(true)}>
                  <Plus className="h-4 w-4 mr-2" />
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <span
                            className={`px-2 py-1 text-xs font-medium rounded-full ${getQualityColor(activity.quality)}`}
                          >
                        ...
                        {activity.musyrifFeedback && (
                          <div className="mt-2 p-2 bg-green-50 rounded text-sm">
                            <strong>Feedback Musyrif:</strong>{" "}
                            {activity.musyrifFeedback}
                          </div>
                        )}
                      </div>
              ...
              <Card key={goal.id}>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`px-2 py-1 text-xs font-medium rounded-full ${getCategoryColor(goal.category)}`}
                    >
