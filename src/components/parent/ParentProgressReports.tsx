    ...
    goals: [
      {
        ...
        description:
          "Program pengembangan jiwa kepemimpinan dan tanggung jawab",
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">
            Laporan Progress {santriName}
          </h2>
          <p className="text-gray-600">
            {santriNis} � {halaqahName} � Periode:{" "}
            {formatBehaviorDate(mockProgressReport.period.startDate)} -{" "}
            {formatBehaviorDate(mockProgressReport.period.endDate)}
          </p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p
                  className={`text-2xl font-bold ${getGradeColor(mockProgressReport.overview.characterGrade).split(" ")[0]}`}
                >
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-blue-600">
                  {mockProgressReport.overview.behaviorScore}
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-teal-600">
                  {mockProgressReport.overview.attendanceRate}%
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {mockProgressReport.overview.academicProgress}%
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <div className="text-lg font-bold text-green-600">
                  {mockProgressReport.behaviorSummary.positiveCount}
                </div>
                <div className="text-xs text-gray-600">Positif</div>
              </div>
              <div>
                <div className="text-lg font-bold text-red-600">
                  {mockProgressReport.behaviorSummary.negativeCount}
                </div>
                <div className="text-xs text-gray-600">Negatif</div>
              </div>
              <div>
                <div className="text-lg font-bold text-gray-900">
                  {mockProgressReport.behaviorSummary.totalPoints}
                </div>
            ...
            <div className="space-y-2">
              ...
              {mockProgressReport.behaviorSummary.byCategory.map((category) => (
                ...
                >
                  <span
                    className={`px-2 py-1 text-xs rounded-full ${getBehaviorCategoryColor(category.category)}`}
                  >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span
                      className={`font-medium ${category.points > 0 ? "text-green-600" : "text-red-600"}`}
                    >
                      {category.points > 0 ? "+" : ""}
                      {category.points}
                    </span>
              ...
              {mockProgressReport.behaviorSummary.trends.improving && (
                <div className="flex items-center space-x-1 text-green-600">
                  ...
                  <span className="text-sm font-medium">
                    Berkembang{" "}
                    {mockProgressReport.behaviorSummary.trends.trendPercentage}%
                  </span>
                </div>
              )}
            </div>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm text-gray-600">
                  {
                    mockProgressReport.academicProgress.hafalanProgress
                      .currentSurah
                  }
                </span>
                <span className="text-sm font-medium">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${mockProgressReport.academicProgress.hafalanProgress.percentage}%`,
                  }}
                ></div>
              </div>
              <p className="text-xs text-gray-600 mt-1">
                ...
                dari{" "}
                {mockProgressReport.academicProgress.hafalanProgress.totalAyat}{" "}
                ayat
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm text-gray-600">
                  Level{" "}
                  {mockProgressReport.academicProgress.tajwidProgress.level}
                </span>
                <span className="text-sm font-medium">
                  {
                    mockProgressReport.academicProgress.tajwidProgress
                      .percentage
                  }
                  %
                </span>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${mockProgressReport.academicProgress.tajwidProgress.percentage}%`,
                  }}
                ></div>
              </div>
              <p className="text-xs text-gray-600 mt-1">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                <div>
                  <div className="text-lg font-bold text-green-600">
                    {mockProgressReport.academicProgress.readingFluency.wpm}
                  </div>
                ...
                <div>
                  <div className="text-lg font-bold text-blue-600">
                    {
                      mockProgressReport.academicProgress.readingFluency
                        .accuracy
                    }
                    %
                  </div>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                {mockProgressReport.behaviorSummary.strengths
                  .slice(0, 3)
                  .map((strength, index) => (
            ...
            <div>
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                {mockProgressReport.behaviorSummary.areasForImprovement
                  .slice(0, 3)
                  .map((area, index) => (
                    <li key={index} className="flex items-start space-x-2">
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                {mockProgressReport.behaviorSummary.recommendations
                  .slice(0, 4)
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-2">
                {mockProgressReport.musyrifNotes.strengths.map(
                  (note, index) => (
                    <p
                      key={index}
                      className="text-sm text-gray-600 p-2 bg-green-50 rounded border-l-4 border-green-400"
                    >
                      {note}
                    </p>
                  ),
            ...
            <div>
              ...
              <div className="space-y-2">
                {mockProgressReport.musyrifNotes.nextSteps.map(
                  (step, index) => (
                    <p
                      key={index}
                      className="text-sm text-gray-600 p-2 bg-blue-50 rounded border-l-4 border-blue-400"
                    >
                      {step}
                    </p>
                  ),
