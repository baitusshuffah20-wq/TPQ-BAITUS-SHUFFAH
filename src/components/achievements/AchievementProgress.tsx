...
const AchievementProgress: React.FC<AchievementProgressProps> = ({
  ...
  const formatCriteriaType = (type: string) => {
    switch (type) {
      case 'SURAH_COUNT': return 'Jumlah Surah';
      case 'AYAH_COUNT': return 'Jumlah Ayat';
      case 'PERFECT_SCORE': return 'Nilai Sempurna';
      case 'STREAK': return 'Hari Berturut-turut';
      case 'TIME_BASED': return 'Berbasis Waktu';
      ...
      {showDetails && (
        <div className="flex justify-between text-xs text-gray-600 mt-1">
          <div className="flex items-center">
            ...
            <span>Target: {formatCriteriaCondition(badge.criteriaCondition)} {badge.criteriaValue}</span>
          </div>
          <div className="flex items-center">
        ...
        <div className="mt-3 pt-3 border-t border-gray-100">
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div>
              ...
              <span className="ml-1 font-medium">{formatCriteriaType(badge.criteriaType)}</span>
            </div>
            <div>
