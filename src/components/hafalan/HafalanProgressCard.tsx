    ...
    <Card className="hover:shadow-lg transition-shadow duration-200">
      ...
      <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              {recentRecords.slice(0, 2).map((record) => (
                ...
                >
                  ...
                  {record.grade && (
                    <span
                      className={`text-xs font-medium px-2 py-1 rounded ${getGradeColor(record.grade)}`}
                    >
                      {record.grade}
                    </span>
                  )}
        ...
        <div className="flex space-x-2 pt-2">
          ...
          <Button size="sm" onClick={onAddHafalan} className="flex-1">
        ...
        <div className="text-xs text-gray-500 text-center pt-2 border-t border-gray-100">
          Terakhir diperbarui:{" "}
          {new Date(progress.lastUpdated).toLocaleDateString("id-ID", {
            day: "numeric",
            month: "short",
            year: "numeric",
            hour: "2-digit",
