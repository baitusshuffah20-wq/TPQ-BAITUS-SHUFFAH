      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <span
              className={`px-3 py-1 text-sm font-medium rounded-full ${getSessionTypeColor(sessionType)}`}
            >
            ...
            {recentScans.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">
                  Belum ada santri yang scan QR Code
                </p>
                <p className="text-sm text-gray-500">
                  Scan akan muncul di sini secara real-time
                </p>
              </div>
            ) : (
        ...
        <CardContent>
          <div className="space-y-3 text-sm text-gray-600">
            ...
            <div className="flex items-start space-x-3">
              ...
              <p>
                Tampilkan QR Code di layar atau cetak untuk ditempel di kelas
              </p>
            </div>
            <div className="flex items-start space-x-3">
              <span className="flex-shrink-0 w-6 h-6 bg-teal-100 text-teal-600 rounded-full flex items-center justify-center text-xs font-bold">
