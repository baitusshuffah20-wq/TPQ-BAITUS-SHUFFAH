  ...
  const loadUserList = async () => {
    try {
      ...
      if (data.success) {
        ...
        setUserList([
          { id: 'user1', name: 'Ustadz Abdullah', email: 'ustadz.abdullah@rumahtahfidz.com', role: 'MUSYRIF' },
          { id: 'user2', name: 'Ustadz Ahmad', email: 'ustadz.ahmad@rumahtahfidz.com', role: 'MUSYRIF' },
          { id: 'user3', name: 'Ustadz Rahman', email: 'ustadz.rahman@rumahtahfidz.com', role: 'MUSYRIF' }
        ]);
      }
  ...
  const validateForm = () => {
    ...
    experience.forEach((exp, index) => {
      ...
      if (!exp.organization.trim()) {
        newErrors[`experience_${index}_organization`] = 'Organisasi wajib diisi';
      }
      if (!exp.startDate) {
        newErrors[`experience_${index}_startDate`] = 'Tanggal mulai wajib diisi';
      }
    });
    ...
    certificates.forEach((cert, index) => {
      ...
      if (!cert.issueDate) {
        newErrors[`certificate_${index}_issueDate`] = 'Tanggal terbit wajib diisi';
      }
    });
                        ...
                        >
                          ...
                          {halaqahList.map((halaqah) => (
                            <option key={halaqah.id} value={halaqah.id}>
                              {halaqah.name} - {halaqah.level} ({halaqah.santriCount || 0} santri)
                            </option>
                          ))}
                        </select>
                      </div>
                ...
                <div>
                  ...
                  {education.length === 0 ? (
                    <div className="text-center py-8 bg-gray-50 rounded-lg">
                      ...
                      <h3 className="text-lg font-medium text-gray-900 mb-2">Belum ada data pendidikan</h3>
                      <p className="text-gray-600 mb-6">Tambahkan riwayat pendidikan untuk musyrif ini.</p>
                      <Button
                        variant="outline"
                        onClick={addEducation}
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <input
                                type="text"
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
                                  errors[`education_${index}_year`] ? 'border-red-500' : 'border-gray-300'
                                }`}
                                value={edu.year}
                ...
                <div>
                  ...
                  {experience.length === 0 ? (
                    <div className="text-center py-8 bg-gray-50 rounded-lg">
                      ...
                      <h3 className="text-lg font-medium text-gray-900 mb-2">Belum ada data pengalaman</h3>
                      <p className="text-gray-600 mb-6">Tambahkan pengalaman kerja untuk musyrif ini.</p>
                      <Button
                        variant="outline"
                        onClick={addExperience}
                        className="flex items-center gap-1 mx-auto"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <input
                                type="text"
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
                                  errors[`experience_${index}_position`] ? 'border-red-500' : 'border-gray-300'
                                }`}
                                value={exp.position}
                            ...
                            <div>
                              ...
                              <input
                                type="text"
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
                                  errors[`experience_${index}_organization`] ? 'border-red-500' : 'border-gray-300'
                                }`}
                              ...
                              {errors[`experience_${index}_organization`] && (
                                <p className="text-red-500 text-sm mt-1">{errors[`experience_${index}_organization`]}</p>
                              )}
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-gray-700 mb-2">
                              ...
                              <input
                                type="date"
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
                                  errors[`experience_${index}_startDate`] ? 'border-red-500' : 'border-gray-300'
                                }`}
                                value={exp.startDate}
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <label className="flex items-center space-x-2 cursor-pointer">
                                  ...
                                  />
                                  <span className="text-sm text-gray-700">Masih bekerja</span>
                                </label>
                              </div>
                            </div>
                            <div className="md:col-span-2">
                ...
                <div>
                  ...
                  {certificates.length === 0 ? (
                    <div className="text-center py-8 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-gray-600 mb-6">Tambahkan sertifikat dan dokumen untuk musyrif ini.</p>
                      <Button
                        variant="outline"
                        onClick={addCertificate}
                        className="flex items-center gap-1 mx-auto"
                    ...
                    <div className="space-y-6">
                      {certificates.map((cert, index) => (
                        <div key={index} className="p-4 border border-gray-200 rounded-lg">
                          <div className="flex justify-between items-start mb-4">
                            <h4 className="font-medium text-gray-900">Sertifikat {index + 1}</h4>
                            <Button
                              variant="ghost"
                              size="sm"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <input
                                type="text"
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
                                  errors[`certificate_${index}_name`] ? 'border-red-500' : 'border-gray-300'
                                }`}
                                value={cert.name}
                              ...
                              {errors[`certificate_${index}_name`] && (
                                <p className="text-red-500 text-sm mt-1">{errors[`certificate_${index}_name`]}</p>
                              )}
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-gray-700 mb-2">
                              ...
                              <input
                                type="text"
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
                                  errors[`certificate_${index}_issuer`] ? 'border-red-500' : 'border-gray-300'
                                }`}
                                value={cert.issuer}
                              ...
                              {errors[`certificate_${index}_issuer`] && (
                                <p className="text-red-500 text-sm mt-1">{errors[`certificate_${index}_issuer`]}</p>
                              )}
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-gray-700 mb-2">
                              ...
                              <input
                                type="date"
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
                                  errors[`certificate_${index}_issueDate`] ? 'border-red-500' : 'border-gray-300'
                                }`}
                                value={cert.issueDate}
                                onChange={(e) => updateCertificate(index, 'issueDate', e.target.value)}
                              />
                              {errors[`certificate_${index}_issueDate`] && (
                                <p className="text-red-500 text-sm mt-1">{errors[`certificate_${index}_issueDate`]}</p>
                              )}
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-gray-700 mb-2">
                              ...
                              <div className="flex items-center space-x-2">
                                <label className="flex-1 flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50">
                                  ...
                                  <span className="text-sm text-gray-700">
                                    {cert.documentFile ? cert.documentFile.name : 'Pilih file'}
                                  </span>
                                  <input
                                    type="file"
                  ...
                  <div className="space-y-6">
                    <div className="p-4 bg-yellow-50 rounded-lg">
                      <p className="text-yellow-800">
                        Akun musyrif digunakan untuk login ke sistem. Setiap musyrif harus memiliki akun dengan role MUSYRIF.
                      </p>
                    </div>
                    ...
                    {!editData ? (
                      <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            onChange={(e) => handleInputChange('createAccount', e.target.checked ? 'true' : 'false')}
                            className="rounded border-gray-300 text-teal-600 focus:ring-teal-500"
                          />
                        ...
                        {formData.createAccount ? (
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1">Pilih akun yang sudah ada dengan role MUSYRIF</p>
                          </div>
                        )}
                      </div>
                    ) : (
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Anda dapat mengubah akun yang terhubung dengan musyrif ini</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div>
                  {activeTab !== 'personal' && (
                    <Button
                      variant="outline"
                      onClick={() => {
                        const tabs = ['personal', 'education', 'experience', 'certificates', 'account'];
