...
const AddAttendanceModal: React.FC<AddAttendanceModalProps> = ({
  ...
  const handleSave = () => {
    ...
    const attendanceData = {
      ...
      presentCount: formData.attendanceList.filter(
        (a) => a.status === "PRESENT",
      ).length,
      absentCount: formData.attendanceList.filter((a) => a.status === "ABSENT")
        .length,
      lateCount: formData.attendanceList.filter((a) => a.status === "LATE")
        .length,
      sickCount: formData.attendanceList.filter((a) => a.status === "SICK")
        .length,
      permissionCount: formData.attendanceList.filter(
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleInputChange("halaqah", e.target.value)
                      }
                    >
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                    ...
                    Daftar Kehadiran Santri ({
                      formData.attendanceList.length
                    }{" "}
                    santri)
                  </h3>
                  ...
                  <div className="grid grid-cols-5 gap-4 mb-6">
                    <div className="text-center p-3 bg-green-50 rounded-lg">
                      <div className="text-lg font-bold text-green-600">
                        {
                          formData.attendanceList.filter(
                            (a) => a.status === "PRESENT",
                          ).length
                        }
                      </div>
                              ...
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  <p className="font-medium text-gray-900">
                                    {attendance.santriName}
                                  </p>
                                  <p className="text-sm text-gray-500">
                                    NIS: {attendance.santriNis}
                                  </p>
                                </div>
                              </div>
                            </td>
