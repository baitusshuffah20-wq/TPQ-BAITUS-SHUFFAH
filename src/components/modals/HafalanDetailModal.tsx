              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-medium ${getTypeColor(hafalan.type)}`}
                    >
                      {getTypeText(hafalan.type)}
                    </span>
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(hafalan.status)}`}
                    >
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  ...
                  <div className="text-center p-4 bg-yellow-50 rounded-lg">
                    <div
                      className={`text-2xl font-bold ${getGradeColor(hafalan.grade || 0)}`}
                    >
                      {hafalan.grade || "-"}
                    </div>
                    <div className="text-sm text-gray-600">Rata-rata</div>
                    <div
                      className={`text-xs font-medium mt-1 ${getGradeColor(hafalan.grade || 0)}`}
                    >
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <span
                        className={`inline-flex px-3 py-1 rounded-full text-sm font-medium ${getTypeColor(hafalan.type)}`}
                      >
                        {getTypeText(hafalan.type)}
                      </span>
                    </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <span
                        className={`inline-flex px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(hafalan.status)}`}
                      >
                        {getStatusText(hafalan.status)}
                      </span>
                    </div>
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span
                          className={`text-sm font-medium ${getGradeColor(hafalan.grade || 0)}`}
                        >
                          ({hafalan.grade ? getGradeText(hafalan.grade) : "-"})
                        </span>
                      </div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">
                        {new Date(
                          hafalan.updatedAt || hafalan.date,
              ...
              <div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    Fitur rekaman audio akan tersedia dalam update mendatang
                  </p>
