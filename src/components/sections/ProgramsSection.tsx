    ...
    const fetchPrograms = async () => {
      try {
        ...
        if (data.success) {
          ...
          const transformedPrograms = data.programs.map((program: any, index: number) => {
            ...
            const popular = index === 0 || program.title.toLowerCase().includes('intensif');
          ...
          transformedPrograms.sort((a, b) => (a.order || 999) - (b.order || 999));
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <CardContent className="pt-0">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm font-medium text-gray-900">{program.ageGroup}</div>
                      </div>
                    </div>
        ...
        {!loading && !error && programs.length === 0 && (
          <div className="text-center py-10">
            <p className="text-gray-600">Tidak ada program yang tersedia saat ini.</p>
          </div>
        )}
