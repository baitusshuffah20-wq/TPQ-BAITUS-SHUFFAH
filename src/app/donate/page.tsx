          ...
          <div className="mb-12">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Pilih program donasi yang ingin Anda dukung untuk kemajuan TPQ
                Baitus Shuffah
              </p>
            </div>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-3">
                        <div
                          ...
                          style={{
                            width: `${getProgress(campaign.collected, campaign.target)}%`,
                          }}
                        ></div>
                      </div>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        BSI: 7208593212 a.n TPQ Baitus Shuffah
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Kartu Kredit, E-Wallet, Virtual Account
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Membantu pembangunan ruang kelas yang nyaman
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
