        ...
        <Card className="max-w-md w-full mx-4">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Instruksi pembayaran tidak dapat ditemukan atau telah kedaluwarsa.
            </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <Button
                      onClick={() =>
                        copyToClipboard(paymentInstructions.orderId, "Order ID")
                      }
                      variant="outline"
                      size="sm"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    Klik "Cek Status" setelah melakukan pembayaran untuk
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-2 text-yellow-800">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">
                    Hubungi admin jika pembayaran tidak terverifikasi dalam 1x24
                    jam
                  </span>
                </div>
              </div>
