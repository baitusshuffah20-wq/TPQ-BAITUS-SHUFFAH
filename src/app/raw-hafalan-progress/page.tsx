    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-4xl">
        ...
        <p className="text-gray-600 mb-6">
          This page uses raw SQL queries to check and seed hafalan progress data.
        </p>
            ...
            {checkLoading ? (
              ...
              <div>
                ...
                {data.count > 0 ? (
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Santri</th>
                          <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Surah</th>
                        ...
                        {data.records.map((record: any) => (
                          <tr key={record.id}>
                            <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500">
                              {typeof record.id === 'string' ? record.id.substring(0, 8) : record.id}...
                            </td>
                            <td className="px-4 py-2 whitespace-nowrap">
                              <div className="text-sm font-medium text-gray-900">{record.santriName}</div>
                              <div className="text-sm text-gray-500">NIS: {record.santriNis}</div>
                            </td>
                            <td className="px-4 py-2 whitespace-nowrap">
                  ...
                  <p className="text-gray-500 mt-2">No records found in the hafalan_progress table.</p>
                )}
              </div>
            ) : (
