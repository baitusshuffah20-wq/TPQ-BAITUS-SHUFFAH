...
const InstitutionSettingsPage = () => {
  ...
  const [institutionData, setInstitutionData] = useState({
    ...
    content: {
      vision:
        "Menjadi lembaga pendidikan tahfidz Al-Quran terdepan yang mencetak generasi Qurani yang berakhlak mulia.",
      mission: [
      ...
      history:
        "TPQ Baitus Shuffah didirikan pada tahun 2020 dengan visi menjadi lembaga pendidikan tahfidz terdepan. Dimulai dengan 20 santri, kini telah berkembang menjadi lembaga yang dipercaya oleh ratusan keluarga.",
      facilities: [
        "Ruang kelas ber-AC",
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Kelola informasi dan pengaturan lembaga
            </p>
          </div>
              ...
              <CardContent>
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-900">
                    {institutionData.basic.name}
                  </h3>
                  <p className="text-xs text-gray-500">
                    {institutionData.basic.description}
                  </p>
                </div>
              </CardContent>
            </Card>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900">
                          {institutionData.basic.shortName}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900">
                          {institutionData.basic.established}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900">
                          {institutionData.basic.accreditation}
                        </p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900">
                          {institutionData.contact.whatsapp}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900">
                          {institutionData.contact.website}
                        </p>
                      )}
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-gray-900">
                            {institutionData.contact.socialMedia.facebook}
                          </p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          <input
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                            value={
                              institutionData.contact.socialMedia.instagram
                            }
                            onChange={(e) =>
                              handleNestedInputChange(
                                "contact",
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-gray-900">
                            {institutionData.contact.socialMedia.youtube}
                          </p>
                        )}
                      </div>
                    </div>
                  ...
                  <CardContent className="space-y-6">
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900">
                          {institutionData.content.vision}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        <div className="space-y-2">
                          {institutionData.content.mission.map(
                            (item, index) => (
                              <div
                                key={index}
                              ...
                              >
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() =>
                                    removeArrayItem("content", "mission", index)
                                  }
                                >
                                  Hapus
                                </Button>
                ...
                <Card>
                  ...
                  <CardContent>
                    {isEditing ? (
                      ...
                      <p className="text-gray-900">
                        {institutionData.content.history}
                      </p>
                    )}
                  </CardContent>
                </Card>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card>
                    ...
                    <CardContent>
                      {isEditing ? (
                        <div className="space-y-2">
                          {institutionData.content.facilities.map(
                            (item, index) => (
                              <div
                                key={index}
                                className="flex items-center space-x-2"
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              addArrayItem("content", "facilities")
                            }
                          >
                            Tambah Fasilitas
                          </Button>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      {isEditing ? (
                        <div className="space-y-2">
                          {institutionData.content.programs.map(
                            (item, index) => (
                              <div
                                key={index}
                                className="flex items-center space-x-2"
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">
                      ...
                      <li>
                        • Favicon: Ukuran 32x32px atau 64x64px, format ICO/PNG
                      </li>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900">
                          {institutionData.operational.academicYear}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900">
                          {institutionData.operational.semester}
                        </p>
                      )}
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          <input
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                            value={
                              institutionData.operational.operatingHours
                                .weekdays
                            }
                            onChange={(e) =>
                              handleNestedInputChange(
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          <input
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                            value={
                              institutionData.operational.operatingHours.sunday
                            }
                            onChange={(e) =>
                              handleNestedInputChange(
                                "operational",
