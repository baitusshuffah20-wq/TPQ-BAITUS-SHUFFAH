                  ...
                  <div className="ml-3 w-full">
                    ...
                    {result.database && (
                      <div className="mt-4 border-t border-green-200 pt-4">
                        <h4 className="text-sm font-medium text-green-800 mb-2">Database Information</h4>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <p className="text-xs text-green-600">Database Type</p>
                            <p className="text-sm font-medium">{result.database.type}</p>
                          </div>
                          <div>
                            <p className="text-xs text-green-600">MySQL Version</p>
                            <p className="text-sm font-medium">{result.database.version}</p>
                          </div>
                        </div>
                        
                        <h4 className="text-sm font-medium text-green-800 mt-4 mb-2">Table Records</h4>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          {result.database.tables && Object.entries(result.database.tables).map(([table, count]) => (
                            <div key={table} className="bg-white p-3 rounded-lg border border-green-100 shadow-sm">
                              <p className="text-xs text-green-600 capitalize">{table}</p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium text-gray-700">Database Provider</h3>
                <p className="mt-1 text-sm text-gray-900">MySQL</p>
              </div>
              
              <div>
                <h3 className="text-sm font-medium text-gray-700">Database Name</h3>
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-700">Connection String Format</h3>
                <p className="mt-1 text-sm text-gray-900 font-mono">mysql://username:password@localhost:3306/tpq_baitus_shuffah</p>
              </div>
            </div>
          </CardContent>
        </Card>
