  ...
  const testimonials = [
    {
      ...
      content:
        "Alhamdulillah, anak saya sudah hafal 3 juz dalam waktu 1 tahun berkat program tahfidz di TPQ Baitus Shuffah. Metode pembelajarannya sangat efektif dan menyenangkan.",
    ...
    },
    {
      ...
      role: "Orang Tua Santri",
      content:
        "Program tahsin sangat membantu anak saya memperbaiki bacaan Al-Quran. Sekarang dia sudah bisa membaca dengan tartil dan sesuai tajwid.",
    ...
    },
    {
      ...
      role: "Alumni Santri",
      content:
        "Pendidikan akhlak yang saya dapatkan di TPQ Baitus Shuffah sangat bermanfaat dalam kehidupan sehari-hari. Saya belajar bagaimana menjadi muslim yang baik.",
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12 max-w-3xl mx-auto">
            ...
            <p className="text-gray-600">
              TPQ Baitus Shuffah menawarkan berbagai program pendidikan Al-Quran
              dan pembentukan akhlak yang dirancang untuk mengembangkan potensi
              santri secara optimal. Setiap program memiliki kurikulum
              terstruktur dan diajarkan oleh pengajar yang berpengalaman.
            </p>
          </div>
          ...
          <div className="space-y-16 mb-16">
            {programs.map((program, index) => (
              <div key={program.id} id={program.id} className="scroll-mt-20">
                <Card
                  className={`border-${program.color}-100 hover:shadow-lg transition-shadow`}
                >
                  <CardHeader
                    className={`bg-gradient-to-r from-${program.color}-50 to-${program.color}-100 rounded-t-lg`}
                  >
                    <div className="flex flex-col md:flex-row md:items-center gap-4">
                      ...
                      <div>
                        <CardTitle
                          className={`text-2xl text-${program.color}-700`}
                        >
                          {program.title}
                        </CardTitle>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                          <CheckCircle
                            className={`h-5 w-5 text-${program.color}-600 mr-2`}
                          />
                          Fitur Program
                        </h3>
                        <ul className="space-y-2">
                          {program.features.map((feature, idx) => (
                            <li key={idx} className="flex items-start gap-2">
                              <div
                                className={`w-2 h-2 bg-${program.color}-500 rounded-full mt-2`}
                              ></div>
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {program.levels.map((level, idx) => (
                            <div
                              key={idx}
                              className={`p-3 rounded-md bg-${program.color}-50 border border-${program.color}-100`}
                            >
                              <h4
                                className={`font-medium text-${program.color}-700`}
                              >
                                {level.name}
                              </h4>
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          <div className="flex items-start gap-2">
                            <Clock
                              className={`h-5 w-5 text-${program.color}-600 flex-shrink-0`}
                            />
                            <div>
                          ...
                          <Button
                            asChild
                            className={`mt-4 bg-${program.color}-600 hover:bg-${program.color}-700 w-full`}
                          >
                            <Link href="/register">Daftar Program</Link>
                          </Button>
                        </div>
                      </div>
                    </div>
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Jawaban untuk pertanyaan yang sering diajukan tentang program
                kami
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold text-teal-600 mb-2">
                    Apakah ada tes masuk untuk program tahfidz?
                  </h3>
                  <p className="text-gray-600">
                    Tidak ada tes masuk khusus, namun kami akan melakukan
                    asesmen awal untuk menentukan tingkat kemampuan santri agar
                    bisa ditempatkan di kelas yang sesuai.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold text-teal-600 mb-2">
                    Berapa biaya untuk mengikuti program?
                  </h3>
                  <p className="text-gray-600">
                    Biaya program bervariasi tergantung jenis dan durasinya.
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Ya, kami menyediakan laporan perkembangan berkala dan
                    pertemuan orang tua-guru setiap 3 bulan sekali untuk
                    membahas kemajuan santri.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold text-teal-600 mb-2">
                    Bagaimana jika anak saya belum bisa membaca Al-Quran?
                  </h3>
                  <p className="text-gray-600">
                    Kami memiliki program tahsin dasar untuk santri yang belum
                    bisa membaca Al-Quran. Santri akan diajarkan dari pengenalan
                    huruf hijaiyah hingga mampu membaca dengan lancar.
                  </p>
                </CardContent>
              </Card>
            </div>
