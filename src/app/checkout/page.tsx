  ...
  useEffect(() => {
    ...
    if (cartId) {
      ...
      const paymentUrl = user
        ? `/dashboard/${user.role.toLowerCase()}/payment`
        : "/payment";
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.data.paymentUrl) {
          ...
          router.push(
            `/payment/instructions?orderId=${data.data.orderId}&paymentId=${data.data.paymentId}`,
          );
        }
      } else {
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                    ...
                    <p className="text-xs text-green-700 mt-1">
                      Transaksi dienkripsi dan diproses melalui gateway
