...
export async function PUT(
  ...
  try {
    ...
    const updatedCategory = {
      ...
      title:
        data.title !== undefined ? data.title : categories[categoryIndex].title,
      description:
      ...
      collected:
        data.collected !== undefined
          ? data.collected
          : categories[categoryIndex].collected,
      icon:
        data.icon !== undefined ? data.icon : categories[categoryIndex].icon,
      color:
        data.color !== undefined ? data.color : categories[categoryIndex].color,
      bgColor:
        data.bgColor !== undefined
          ? data.bgColor
          : categories[categoryIndex].bgColor,
      urgent:
        data.urgent !== undefined
          ? data.urgent
          : categories[categoryIndex].urgent,
      isActive:
        data.isActive !== undefined
          ? data.isActive
          : categories[categoryIndex].isActive,
      order:
        data.order !== undefined ? data.order : categories[categoryIndex].order,
    };
