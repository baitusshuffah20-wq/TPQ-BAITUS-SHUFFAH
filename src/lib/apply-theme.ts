...
function applyButtonStyles(theme: ThemeConfig): void {
  // Primary buttons
  const primaryButtons = document.querySelectorAll('.btn-primary, .bg-primary, .bg-teal-600, .bg-teal-700');
  primaryButtons.forEach(button => {
    (button as HTMLElement).style.backgroundColor = theme.buttons.primary;
  });
  
  // Secondary buttons
  const secondaryButtons = document.querySelectorAll('.btn-secondary, .bg-secondary');
  ...
  // Danger buttons
  const dangerButtons = document.querySelectorAll('.btn-danger, .bg-danger, .bg-red-600, .bg-red-700');
...
function applyBreadcrumbStyles(theme: ThemeConfig): void {
  const activeBreadcrumbs = document.querySelectorAll('.breadcrumb-item.active');
...
function applySwitchStyles(theme: ThemeConfig): void {
  const switches = document.querySelectorAll('.form-switch .form-check-input:checked');
...
function applyDatepickerStyles(theme: ThemeConfig): void {
  const datepickerCells = document.querySelectorAll('.datepicker-cell.selected');
