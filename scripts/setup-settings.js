...
async function setupSettings() {
  ...
  try {
    ...
    connection = await mysql.createConnection({
      host: "localhost",
      user: "root",
      password: "admin123", // Password from .env
      database: "db_tpq",
    });

    console.log("Connected to database");

    // Create site_setting table
    ...
    console.log("Table site_setting created successfully");
    ...
    const settings = [
      ...
      [
        "cuid_site_maintenance",
        "site.maintenanceMode",
        "false",
        "BOOLEAN",
        "SYSTEM",
        "Mode Maintenance",
        "Status mode pemeliharaan situs",
        1,
      ],
      [
        "cuid_site_logo",
      ...
      [
        "cuid_about_achievements",
        "about.achievements",
        "Juara 1 MTQ Tingkat Provinsi 2022, Juara 2 Tahfidz Nasional 2023, 250+ Alumni Hafidz 30 Juz",
        "STRING",
        "ABOUT",
        "Prestasi",
      ...
      [
        ...
        "Senin-Jumat: 07:00-17:00, Sabtu: 07:00-15:00, Minggu: 08:00-12:00",
        "STRING",
        "CONTACT",
        "Jam Operasional",
        "Jam operasional lembaga",
        1,
      ],

      [
        "cuid_integration_whatsapp_token",
        "integration.whatsapp.token",
        "",
        "STRING",
        "INTEGRATION",
        "WhatsApp Token",
      ...
      [
        "cuid_integration_email_username",
      ...
      [
        "cuid_integration_email_password",
      ...
      [
        "cuid_integration_payment_gateway",
        "integration.payment.gateway",
        "midtrans",
        "STRING",
        "INTEGRATION",
        "Payment Gateway",
        "Layanan payment gateway yang digunakan",
        0,
      ],
    ];

    const insertSQL = `
      INSERT INTO \`site_setting\` (\`id\`, \`key\`, \`value\`, \`type\`, \`category\`, \`label\`, \`description\`, \`isPublic\`) 
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
